...
class UpdateFaqView extends GetView<UpdateFaqController> {
  const UpdateFaqView({super.key});
  @override
  Widget build(BuildContext context) {
    Get.put(UpdateFaqController());
    return Scaffold(
      appBar: CustomAppBar(title: 'Update FAQ'),
      body: Obx(
        () => ListView(
            ...
            Row(
              ...
              children: [
                SizedBox(
                  width: Get.width * 0.8,
                  child: Text(
                    'Silahkan isi form di bawah ini untuk mengubah FAQ',
